              ...
              >
                ...
                <li className="list-group text-center nav-li-style">
                  ...
                  >
                    ...
                    {isActive ? (
                      <span
                        className="anchorLink nav-span justify-content-cente"
                        style={{ color: "black" }}
                      >
                        Home
                      </span>
                ...
                <div className="d-flex" id="navbarScroll">
                  ...
                  <li className="list-group li-nav Nav-li-styled anchor-Link">
                    <a className="nav-link" href="#">
                      <span className="anchor-Link nav-span text-center">
            ...
            <div>
              <ul>
                <li className="list-group explore-li">
                  <a className="text-decoration-none" href="#">
                    <h3 className=" text-black business-h3">
                      Hire on LinkedIn
                    </h3>
                ...
                <li className="list-group explore-li">
                  <a className="text-decoration-none" href="#">
                    <h3 className=" text-black business-h3">Admin Center</h3>
                    <p className="fw-light business-p">
              ...
              >
                ...
                >
                  ...
                  <li className="list-group li-nav Nav-li-styled anchor-Link">
                    <a className="nav-link" href="#">
                      <span
                        className="anchor-Link nav-span text-center"
                        // style={{ width: "100px" }}
                      >
                        Get hired faster. Try Premium free.
                      </span>
          ...
          <section className="border rounded-3 my-2">
            ...
            <div>
              <ul>
                <li className="list-group explore-li">
                  <a className="text-decoration-none" href="#">
                    <h3 className="business-h3 text-black">Hire on LinkedIn</h3>
                    <p className="fw-light business-p">
                      Find, attract and recruit talent
                    </p>
                  </a>
